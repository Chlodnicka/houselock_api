 ...
 * FlatGasConfig
 *
 * @ORM\Table(name="flat_gas_config", uniqueConstraints={@ORM\UniqueConstraint(name="flat_id_UNIQUE", columns={"flat_id"}), @ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})}, indexes={@ORM\Index(name="fk_flat_config_flat1_idx", columns={"flat_id"}), @ORM\Index(name="fk_flat_gas_config_config_type1_idx", columns={"config_type_id"})})
 * @ORM\Entity
 */
class FlatGasConfig
{
     ...
     * @ORM\OneToOne(targetEntity="Flat", inversedBy="gasConfig")
